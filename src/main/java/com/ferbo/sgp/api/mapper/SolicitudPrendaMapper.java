...
public interface SolicitudPrendaMapper {
    ...
    @Mapping(source = "empleadoRevisor.nombre", target = "nombreRevisor")
    @Mapping(source = "empleadoRevisor.primeroAp", target = "primerApRevisor")
    @Mapping(source = "empleadoRevisor.segundoAp", target = "segundoApRevisor")
    ...
    @Mapping(source = "nombreRevisor", target = "empleadoRevisor.nombre")
    @Mapping(source = "primerApRevisor", target = "empleadoRevisor.primeroAp")
    @Mapping(source = "segundoApRevisor", target = "empleadoRevisor.segundoAp")
