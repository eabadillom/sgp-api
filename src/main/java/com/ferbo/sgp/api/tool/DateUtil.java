...
public class DateUtil {
     ...
     */
    public static Date getDate(String strFecha, String formato) // throws InventarioException
    {
        Date fecha = null;
        // String formato = null;
     ...
     * parametro (fechaIni) debera ser la fecha menor, mientras que el segundo
     * parametro debera ser la fecha mayor.
     *
     * @param fechaIni
     * @param fechaFin
