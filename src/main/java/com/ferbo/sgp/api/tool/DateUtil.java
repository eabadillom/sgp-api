...
public class DateUtil {
	...
	public static String[] PROP_DIA_SEMANA = { PROP_CD_DOMINGO, PROP_CD_LUNES, PROP_CD_MARTES, PROP_CD_MIERCOLES,
			PROP_CD_JUEVES, PROP_CD_VIERNES, PROP_CD_SABADO };
	 ...
	 *            <li>3 = "Abril"</li>
	 *            <li>etc...</li><br>
	 *            Vea también las <i>constantes de mes</i> de la clase
	 *            {@link DateUtil}
	 ...
	 * 
	 * @param fecha Objeto {@link Date} con la fecha.
	 * @return Dia en formato numérico [1-31]. El rango puede variar, según sea el
	 *         mes
	...
	/**
	 * Devuelve los milisegundos en formato numérico [0-999] del objeto {@link Date}
	 * dado.
	 * 
	 * @param fecha Objeto {@link Date} con la fecha.
	 ...
	 * 
	 * @param fecha Objeto {@link Date} al cual se desea establecer el nuevo valor
	 *              para el año.
	 ...
	 *              {@link Date}.
	 *              Vea las constantes de la clase {@link DateUtil} para establecer
	 *              correctamente el mes.
	 */
	 ...
	 * @param fecha Objeto {@link Date} al cual se desea establecer el nuevo valor
	 *              para la hora.
	 * @param hora  El nuevo valor para la hora que se establecerá en el parámetro
	 *              {@link Date}.
	 */
	...
	public static Date addMinute(Date fecha, int min) {
		...
		calendar.add(Calendar.MINUTE, min); // numero de horas a añadir, o restar en caso de horas<0 TimeZone =
											// "GMT-6:00"
	 ...
	 * @param milisegundo El nuevo valor para los milisegundos que se establecerá en
	 *                    el parámetro {@link Date}.
	 */
	 ...
	 * @param month Mes en formato numérico (int) [0-11]. Vea también las constantes
	 *              de mes
	...
	public static Date getDate(int year, int month, int date, int hour, int minute, int second) {
		...
		// cal = Calendar.getInstance(TimeZone.getTimeZone("GMT-06:00"),
		// Locale.getDefault());
		cal = Calendar.getInstance(TimeZone.getDefault(), Locale.getDefault());
	 ...
	 * <li>MM : Mes (En formato numérico [01-12], donde 01 = Enero, 02 = Febrero,
	 * ...)</li>
	 * <li>yyyy: Año (En formato numérico de cuatro dígitos).</li><br>
	 * <br>
	 * 
	...
	/**
	 * Devuelve la diferencia en dias de dos fechas. De preferencia, el primer
	 * parametro (fechaIni)
	 * debera ser la fecha menor, mientras que el segundo parametro debera ser la
	 * fecha mayor.
	 * 
	 * @param fechaIni
	 * @param fechaFin
	...
	public static OffsetDateTime stringToOffSetTime(String fecha) {
		try {
	...
	public static OffsetDateTime resetOffSetTime(OffsetDateTime dateTime) {
		return dateTime
				.withHour(0)
				.withMinute(0)
				.withSecond(0)
	...
	public static OffsetDateTime setToEndOfDay(OffsetDateTime fecha) {
		return fecha
				.toLocalDate()
				.atTime(LocalTime.of(23, 59, 59, 999_999_999)) // última fracción de segundo del día
				.atOffset(fecha.getOffset());
	}
